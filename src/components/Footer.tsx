...
export default function Footer({ onOpenDemo }: FooterProps) {
  ...
  return (
    <footer id="main-footer" className="bg-[#F7F8FA] border-t border-steel-teal/20 pt-12 pb-6 text-ink">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8">
          ...
          <div className="md:col-span-5 flex flex-col items-start">
            ...
            <p className="font-sans text-base sm:text-lg text-muted-grey leading-relaxed max-w-sm font-semibold">
          ...
          <div className="md:col-span-4 flex flex-col items-start">
            ...
            <div className="space-y-2 text-base text-muted-grey">
              <div className="flex items-center gap-3">
                <MapPin className="h-4 w-4 text-steel-teal shrink-0" />
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:integrations@endomatics.com" className="hover:text-steel-teal transition-all duration-300 font-semibold">
        ...
        <div className="border-t border-gray-200/50 pt-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-center">
          <p className="font-mono text-sm font-bold text-muted-grey">
            © {currentYear} Endomatics Inc. All Rights Reserved.
          </p>
          <div className="flex items-center gap-6 font-mono text-sm text-muted-grey">
